            ...
            <div className="container">
                <div className="row">
                    <div className="jumbotron">
                        ...
                        <h2>A lesson on props, states, parents, and children
                        </h2>
                ...
                <h2>{this.state.name} is a fantastic artist</h2 > <hr/> < h2 > Age : {
                                this.state.age
                            } < /h2>
                <h2>Fuzziness: {this.state.isFuzzy.toString()}</h2 > <h2>Artistry: {this.state.artistry}</h2> < /div>
            </div > </div> < div className = "col-md-6" > <div className="panel panel-default">
                                <div className="panel-body text-center">
